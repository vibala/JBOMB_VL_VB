		...
		for (int i = 0; i < 17; i++) {
			for (int j = 0; j < 23; j++) {
				...
				case MUR:
					...
					break;
				case PLAYER1:
					player1 = new Player((j + 1) * 32, (i + 1) * 32, 16, 16);
					...
					break;
				case PLAYER2:
					player2 = new Player((j + 1) * 32, (i + 1) * 32, 16, 16);
					...
					break;
				case PLAYER3:
					player3 = new Player((j + 1) * 32, (i + 1) * 32, 16, 16);
					...
					break;
				case PLAYER4:
					player4 = new Player((j + 1) * 32, (i + 1) * 32, 16, 16);
